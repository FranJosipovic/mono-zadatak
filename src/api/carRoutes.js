...
export const getCarModels = (searchQuery, page, rpp, sort) => {
  return fetch(
    `https://api.baasic.com/v1/testZad/resources/carModelSchema?page=${page}&rpp=${rpp}&sort=${sort}${
...
const getCarMake = (id) => {
  return fetch(
    `https://api.baasic.com/v1/testZad/resources/carMakeSchema/${id}`,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const updateCarMake = (carMakeId, item) => {
  ...
  newList.push(item);
  return fetch(
    `https://api.baasic.com/v1/testZad/resources/carMakeSchema/${carMakeId}/`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const updateCarModel = (id, newName, newAbrv, newCarMakeId) => {
  return fetch(
    `https://api.baasic.com/v1/testZad/resources/carModelSchema/${id}/`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
