...
import { getCarModels, createCarModel, updateCarMake, deleteCarModel, updateCarModel } from "../api/carRoutes"
...
export class CarModelStore {
    ...
    loadCars(){
        getCarModels(this.query,this.currentPage,this.rpp,this.sort).then(data => {
            runInAction(()=>{
                this.cars = data.item
